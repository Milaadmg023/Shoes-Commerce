...
const FlexContent = ({
  ifExists,
  endpoint: { title, heading, sutitle, text, img, btn, url },
}) => {
  return (
    <>
      <div
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-900 shadow-slate-100 py-1.5 text-white"
            >
              {btn}
            </button>
          </a>
        ...
        <div className="flex items-center justify-center max-w-xl relative lg:max-w-none w-full">
          <img
            ...
            className={`w-auto object-fill transitions-theme ${
              ifExists
                ? "h-60 lg:h-56 md:j-52 sm:h-44 xsm:h-46 rotate-6 hover:-rotate-12"
